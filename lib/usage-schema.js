...
export function normalizeUsage(input, now = new Date()) {
  ...
  return {
    ...
    todayCostUsd: positiveNumber(usage.todayCostUsd, positiveNumber(usage.retailCostUsd, 0)),
    last24hCostUsd: positiveNumber(usage.last24hCostUsd, positiveNumber(usage.retailCostUsd, 0)),
    burnRatePerHour,
    quotaResetAt,
    weeklyBudgetTokens,
    weeklyUsedTokens,
